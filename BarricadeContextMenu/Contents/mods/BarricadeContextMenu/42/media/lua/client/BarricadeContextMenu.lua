...
-- Legacy mod for pre-B42.14; vanilla restored barricade context menus in B42.14.
--
...
-----------------------------------------------------------
-- Version gate: B42.14+ restored vanilla barricade menus
-----------------------------------------------------------
...
if getBuildMinor() >= 14 then
    print("[BarricadeContextMenu] B42.14+ detected, vanilla barricade menus restored. Mod disabled.")
    return
end
